...
def create_record(operator: dict, record_type: str, wp_number: str, applicant_name: str, address: str,
                  barangay: str, occupancy: str, installation: str, bp_number: str = "",
                  coo_number: str = "",
                  remarks: str = "", or_number: str = "", signature_base64: str = None, client_ip: str =
                  None, device_info: str = None, total_cost: float = 0.0, import_batch_id: str = "") -> str:
